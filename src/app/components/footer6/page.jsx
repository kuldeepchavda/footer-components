  ...
  return (
    <>
      <div className={`   w-1/2 gap-4  `}>
        <ul
          className={`w-full flex gap-6   justify-end ${
      ...
      >
        ...
        >
          ...
          <footer className="   mx-auto w-full py-10 md:w-11/12 flex flex-col gap-10 pb-10">
            ...
            <div className=" flex flex-col gap-8 sm:gap-4 md:gap-12 lg:gap-16 md:flex-row border-b border-gray-700 pb-12 justify-between">
              <div className=" w-full md:w-1/2  flex flex-col md:flex-row gap-16  md:gap-28">
              ...
              <div className=" md:w-1/3   ">
                <ul
                  ...
                  } flex flex-col gap-6 font-bold text-lg `}
                >
                  <li>Business hours</li>
                  <ul className="flex flex-col gap-3">
                    <li className=" border-b border-zinc-500 pb-4 flex justify-between">
                      <p>Weekdays</p>{" "}
                      <p className="font-medium">09.00 AM - 21.00 PM</p>
                    </li>
                    <li className=" border-b border-zinc-500 pb-4 flex justify-between">
                      <p>Saturday</p>
                      <p className="font-medium"> 09.00 AM - 18.00 PM </p>
                    </li>
